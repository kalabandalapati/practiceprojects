...
private static final String WELCOME =
        "\n**************** LockedMe.com ******************\n"+
          "\nDeveloped By : KALABANDALAPATI SAI PRASANNA \n";
private static final String mainmenu1=
        "\nMAIN MENU - choose follwing option to experience lockedMe.com : \n"+
...
void searchFile(String filename) {
	...
	public static void main(String[] args) {
		 ...
		 LockedmeApplication menu = new LockedmeApplication();
	        menu.Menu1();
